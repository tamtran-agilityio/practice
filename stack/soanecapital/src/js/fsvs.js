...
;( function($){
  ...
  $.fn.fsvs = function( options ) {
    ...
    var defaults = {
      ...
      bodyID : 'fsvs-body',
      selector : '> .slide',
      selectorTille : '.big-tille',
      selectorDetais : '.details-content',
    ...
    var app = {
      ...
      setSpeed : function( _speed ) {
        speed = _speed/1000;
        body.css({
          '-webkit-transition': 'all ' + speed + 's cubic-bezier(0.5, 0.01, 0.09, 0.99)',
          '-moz-transition' : 'all ' + speed + 's cubic-bezier(0.5, 0.01, 0.09, 0.99)',
          '-o-transition'   : 'all ' + speed + 's cubic-bezier(0.5, 0.01, 0.09, 0.99)',
          'transition'    : 'all ' + speed + 's cubic-bezier(0.5, 0.01, 0.09, 0.99)'
        });
      },
