...
import {CreatActionComponent} from './create-action.component';
import {BoardDetailComponent} from '../boards/board-details.component';

@Component({
  selector: 'board-drawer',
  properties: ['isStart', 'isDisabled'],
  templateUrl:'app/typescript/component/create-board/board-drawer.component.html',
  styleUrls: ['app/typescript/component/create-board/board-drawer.component.css'],
...
export class BoardDrawerComponent implements OnInit {
